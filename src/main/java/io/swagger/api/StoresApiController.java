...
public class StoresApiController implements StoresApi {
    ...
    public ResponseEntity<List<Special>> getAllSpecialsByStore(@Min(0)@ApiParam(value = "a store's unique ID",required=true, allowableValues="") @PathVariable("storeId") Integer storeId) {
        String accept = request.getHeader("Accept");
